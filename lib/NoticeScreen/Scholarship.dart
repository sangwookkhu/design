...
class ScholarshipApp extends StatefulWidget {
  ...
  @override
  _ScholarshipApp createState() => _ScholarshipApp();
}

class _ScholarshipApp extends State<ScholarshipApp> {
  ...
  Future<void> _fetchData() async {
    const url = 'https://www.khu.ac.kr/kor/user/bbs/BMSR00040/list.do?menuNo=200318';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Flutter Web Crawler'),
      ),
