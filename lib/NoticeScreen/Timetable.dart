...
class TimetableApp extends StatefulWidget {
  ...
  @override
  _TimetableApp createState() => _TimetableApp();
}

class _TimetableApp extends State<TimetableApp> {
  ...
  Future<void> _fetchData() async {
    const url = 'https://www.khu.ac.kr/kor/user/bbs/BMSR00040/list.do?menuNo=200320';
