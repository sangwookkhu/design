...
class ExchangeApp extends StatefulWidget {
  ...
  @override
  _ExchangeApp createState() => _ExchangeApp();
}

class _ExchangeApp extends State<ExchangeApp> {
  ...
  Future<void> _fetchData() async {
    const url = 'https://www.khu.ac.kr/kor/user/bbs/BMSR00040/list.do?menuNo=200319';
